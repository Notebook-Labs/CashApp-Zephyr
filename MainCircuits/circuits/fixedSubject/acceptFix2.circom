 ...
 */
template AcceptFix2Regex() {
    signal input in[33];
    var fixed[33] = [32, 121, 111, 117, 32, 115, 101, 110, 116, 32, 102, 111, 114, 32, 0, 0, 0, 0, 32, 0, 0, 0, 0, 32, 0, 0, 0, 0, 32, 0, 0, 0, 0];
    ...
    var claimIndices[16] = [14, 15, 16, 17, 19, 20, 21, 22, 24, 25, 26, 27, 29, 30, 31, 32];
    component lt[2][16];
    for (var i = 0; i < 16; i++) {
        lt[0][i] = LessThan(8);
        lt[0][i].in[0] <== 47;
